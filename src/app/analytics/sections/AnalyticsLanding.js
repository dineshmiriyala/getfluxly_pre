...
export default function AnalyticsLanding() {
  ...
  return (
    <main className="min-h-screen text-gray-900 dark:text-white px-6 py-20 relative overflow-hidden bg-white bg-[radial-gradient(circle_at_top,_#ffffff,_#e9ffe9)] dark:bg-black dark:bg-none">
      <div
        ref={glowRef}
        id="cursor-glow"
        className="pointer-events-none fixed w-64 h-64 bg-[radial-gradient(circle,_rgba(253,230,138,0.9),_rgba(251,191,36,0.35),_transparent)] dark:bg-[radial-gradient(circle,_rgba(74,222,128,0.45),_rgba(16,185,129,0.1),_transparent)] rounded-full blur-3xl transform -translate-x-1/2 -translate-y-1/2 z-0 opacity-90 dark:opacity-100 mix-blend-multiply dark:mix-blend-screen"
      ></div>

      <div className="absolute inset-0 pointer-events-none animate-pulse">
        <div className="w-80 h-80 bg-green-300/30 dark:bg-green-500/20 blur-3xl rounded-full absolute -top-20 -left-10"></div>
        <div className="w-96 h-96 bg-green-200/30 dark:bg-green-600/10 blur-[110px] rounded-full absolute bottom-10 right-0"></div>
      </div>

      <section className="relative z-10 max-w-5xl mx-auto text-center space-y-8">
        <p className="text-sm sm:text-base uppercase tracking-[0.2em] text-green-500 font-semibold animate-shimmer">
          GetFluxly
        </p>
        ...
        <p className="text-gray-600 dark:text-gray-300 text-lg md:text-xl max-w-4xl mx-auto animate-fadeIn">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
          ...
          <a
            ...
            className="px-6 py-3 rounded-full border border-gray-300 dark:border-white/20 hover:border-gray-500 dark:hover:border-white/60 transition"
          >
            Talk to Us
          </a>
        </div>
      ...
      <section className="relative z-10 max-w-6xl mx-auto mt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {featureCards.map((card) => (
            <div
              key={card.title}
              className="rounded-2xl p-6 bg-gradient-to-br from-white to-gray-100 text-gray-700 border border-gray-300 shadow-lg dark:from-gray-800/40 dark:to-gray-900/50 dark:text-gray-300 dark:border-white/10 backdrop-blur-xl hover:scale-[1.03] transition-all duration-300 flex flex-col h-full animate-floatUp"
            >
      ...
      <section className="relative z-10 max-w-4xl mx-auto mt-24 bg-white/80 dark:bg-white/5 border border-green-100/70 dark:border-white/10 rounded-3xl p-10 backdrop-blur-xl">
      ...
      <section className="relative z-10 max-w-5xl mx-auto mt-24 bg-gradient-to-r from-green-50 via-white to-green-100 dark:from-white/10 dark:via-white/10 dark:to-white/5 border border-green-100/70 dark:border-white/10 rounded-3xl p-10 backdrop-blur-xl text-center">
      ...
      <footer className="relative z-10 mt-24 border-t border-green-100/70 dark:border-white/10 pt-8 text-center text-sm text-gray-500 dark:text-gray-400 flex flex-col items-center gap-4">
